...
- **Download TruthSpine App** opens the official store-only acquisition page with JetBrains Marketplace attribution, then offers Microsoft Store or Mac App Store as appropriate.
